		...
		<div class="row-4 m-1">
			<form id="myPage-form" action="${root}/user" method="POST">
				<div class="row text-center">
					<div class="col-4"></div>
					<div class="col-4">
						<img src="/assets/img/etc/no-profile.png" alt="profile"
							style="height: 100px">
					</div>
					<div class="col-4"></div>
				</div>
				<div class="row m-3">
					...
					<div class="col-6">
						<input class="form-mypage w-75" type="text" placeholder="아이디자리"
							readonly="readonly" id="id" name="userId"
				...
				<div class="row m-3">
					...
					<div class="col-6">
						<input class="form-mypage w-75" type="password" id="pw" name="userPwd"
				...
				<div class="row m-3">
					...
					<div class="col-6">
						<input class="form-mypage w-75" type="password" id="pwCheck"
