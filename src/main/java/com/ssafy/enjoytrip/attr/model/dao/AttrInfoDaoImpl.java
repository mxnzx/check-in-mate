...
//
//@Repository("AttrInfoDaoImpl")
//public class AttrInfoDaoImpl implements AttrInfoDao{
//
//	
//	private DBUtil dbUtil;
//	//private static AttrInfoDaoImpl tripController = new AttrInfoDaoImpl(dbUtil);
//
//	// 생성자 호출 시 DB 연결 객체를 받아온다.
//	private AttrInfoDaoImpl(DBUtil dbUtil) {
//		super();
...
//
//	/*
//	 * 도시 정보 가져오기 (화면의 도시정보 Select Box에 담겨진다). Connection : DB 객체에 연결해 SQL문을 적용시키는
//	 * 객체 PreparedStatement : 미리 정의된 SQL문 (문자열로 작성된 SQL)에 매개변수를 삽입(? 위치)해 명령 수행
